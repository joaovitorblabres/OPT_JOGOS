...
class PlayState extends FlxState
{
	...
	override public function create():Void
	{
		...
		_map = new FlxTilemap();
		_map.loadMapFromCSV("assets/pathfinding_map.txt", "assets/tiny-16.png", TILE_WIDTH, TILE_HEIGHT, 0, 1);
		add(_map);
		...
		_action = ACTION_IDLE;
		_destination = 0;
		_unit.acceleration.x = _unit.acceleration.y = 60;
		_unit.maxVelocity.x = _unit.maxVelocity.y = MOVE_SPEED*1000;
	...
	override public function update(elapsed:Float):Void
	{
		...
		if (FlxG.mouse.justPressed) 
		{
			...
			// Change tile toogle
			_map.setTile(mx, my, 88 - _map.getTile(mx, my), true);
		}
