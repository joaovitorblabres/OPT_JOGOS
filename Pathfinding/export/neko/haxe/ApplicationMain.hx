...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("Pathfinding", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("Pathfinding", null, 400, 300);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "Pathfinding";
		app.meta["name"] = "Pathfinding";
